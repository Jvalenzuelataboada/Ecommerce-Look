                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            File file = new File("D:\\CarritoCompras-develop\\CarritoCompras-develop\\web\\img\\productos\\" + fileItem.getName());
                            fileItem.write(file);
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            if (!fileItem.getName().equals("")) {
                                File file = new File("D:\\CarritoCompras-develop\\CarritoCompras-develop\\web\\img\\" + fileItem.getName());
                                fileItem.write(file);
                                p.setImagen("img/productos/" + fileItem.getName());
                            }
                        } else {
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            ...
                            if (!"".equals(nomfoto)) {
                                File file = new File("D:\\CarritoCompras-develop\\CarritoCompras-develop\\web\\img\\fotouser\\" + fileItem.getName());
                                fileItem.write(file);
