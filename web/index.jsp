...
<html>
    <head>
        ...
        <title>Ecommerce Look at me</title>
    </head>
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="nav-item dropdown">
                <a class="navbar-brand" style="color: white" href="#" data-toggle="dropdown"><img src="img/loo.jpeg" width="60" height="60"> Look at me</a>
        ...
        <center>   <a class="dropdown-item" href="#"><img src="img/60.jpeg" width="1000" height="200"/></a>  </center>         
                        ...
                        <div class="form-group">
                            <div class="card">
                                ...
                                <div class="text-center">                             
                                    <img src="${p.getImagen()}" style="height: 300px;width:70%; padding: 8px">
                                </div>
                                <br>
